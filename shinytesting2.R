...
url2 <- a("CONTACYT", href="https://datos.covid-19.conacyt.mx/")
                ...
                fluidRow(
                  ...
                  navbarPage("COVID-19 in Mexico",
                             ...
                             tabPanel("Home", titlePanel("Tracking and Modeling SARS-CoV-2 in Mexico"),
                                      ...
                                      br(),
                                      h4("Modeling Overview and Some Epidemiological Background"),
                             ...
                             navbarMenu("SIR Estimations",
                                        tabPanel("SIR Active", titlePanel("SIR Active Cases Estimation"),
                                                 ...
                                                 br(),p("This graph displays the SIR model for active cases (the 'I' compartment in SIR), which is displayed as the orange line. The blue bars represent the reported number of active cases. The green line after the horizontal white line displays the model's predictions."),
                                                 br(),
                                                 p("Data Source: ", url1)),
